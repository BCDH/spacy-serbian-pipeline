...
doc = nlp('Направљен је споразум да би Србија могла да производи вакцине Спутњик ве, чиме би били референтни за цело подручје Југоисточне Европе, што би било јако добро и за нашу фармацеутску индустрију”, рекао је Лазански за ТВ Пинк, преноси Танјуг.')
